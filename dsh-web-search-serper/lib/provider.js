...
export class SerperSearchProvider {
  /** @param options - resolved options; `apply` supplies the defaults. */
  constructor(options) {
  ...
  available() {
    return this.options.apiKey.length > 0
      ...
      && (this.options.country === undefined || this.options.country.length > 0)
      && (this.options.locale === undefined || this.options.locale.length > 0);
  }
    ...
    try {
      response = await fetch(`${this.options.baseURL}/search`, {
        ...
        body: JSON.stringify({
          q: request?.query ?? "",
          ...num !== undefined ? { num } : {},
          ...this.options.country !== undefined ? { gl: this.options.country } : {},
          ...this.options.locale !== undefined ? { hl: this.options.locale } : {},
        }),
